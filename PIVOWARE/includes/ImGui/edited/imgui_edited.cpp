...
namespace ImGui {
	namespace Edited {
		...
		bool Keybind(const char* label, const char* description, int* key) {
			...
			it_anim->second.text = ImLerp(it_anim->second.text, g.ActiveId == id ? properties::elements::text_active_color : hovered ? properties::elements::text_hover_color : properties::elements::text_color, ImGui::GetIO().DeltaTime * 6.f);

			window->DrawList->AddRectFilled(clickable.Min, clickable.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(properties::elements::text_color), description, ImVec2(0.0, 0.8));

			GetWindowDrawList()->AddRectFilled(rect.Min + ImVec2(width - 80, 0), rect.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);
			GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(80, 0), GetColorU32(properties::elements::background_color, 0.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 0.f), properties::elements::rounding);

			window->DrawList->AddRectFilled(clickable.Min, clickable.Max, GetColorU32(properties::elements::background_widget_color), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(properties::elements::text_active_color), label, ImVec2(0.0, 0.2));

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), clickable.Min, clickable.Max, GetColorU32(properties::elements::text_active_color), buf_display, ImVec2(0.5f, 0.5f));
		...
		bool CheckboxP(const char* label, bool* v, const ImVec2& size_arg) {
			...
			state.background = ImLerp(state.background, *v ? properties::accent_color : properties::elements::background_color, g.IO.DeltaTime * 6.f);
			...
			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), bb.Min, bb.Max - ImVec2(0, 2), GetColorU32(properties::elements::text_active_color), label, ImVec2(0.5, 0.5));
		...
		bool Edited::Tab(bool selected, const char* icon, const char* label, const char* description, const ImVec2& size_arg) {
			...
			state.icon = ImLerp(state.icon, selected ? properties::accent_color : hovered ? properties::elements::text_hover_color : properties::elements::text_color, g.IO.DeltaTime * 6.f);
			state.text = ImLerp(state.text, selected ? properties::elements::text_active_color : hovered ? properties::elements::text_hover_color : properties::elements::text_color, g.IO.DeltaTime * 6.f);
			state.bg_alpha = ImLerp(state.bg_alpha, selected ? 1.f : 0.f, g.IO.DeltaTime * 6.f);
			state.shadow = ImLerp(state.shadow, selected ? properties::tab::tab_active_color : properties::tab::border_color, g.IO.DeltaTime * 6.f);

			GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(properties::tab::tab_active_color, state.bg_alpha), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), bb.Min + ImVec2(size.y, 0), bb.Max, GetColorU32(properties::elements::text_color), description, ImVec2(0.0, 0.7));

			GetWindowDrawList()->AddRectFilledMultiColor(bb.Min + ImVec2(size.x / 2, 0), bb.Max, GetColorU32(state.shadow, 0.f), GetColorU32(state.shadow, 1.f), GetColorU32(state.shadow, 1.f), GetColorU32(state.shadow, 0.f), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), bb.Min + ImVec2(size.y, 0), bb.Max, GetColorU32(state.text), label, ImVec2(0.0, 0.3));
			RenderTextColor(g_pFontManager->GetFont(xorstr_("Icomoon"), 20), bb.Min, bb.Min + ImVec2(size.y, size.y), GetColorU32(state.icon), icon, ImVec2(0.5, 0.5));
		...
		bool Edited::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, ImGuiChildFlags child_flags, ImGuiWindowFlags window_flags) {
			...
			//     GetWindowDrawList()->AddRect(parent_window->DC.CursorPos, parent_window->DC.CursorPos + size_arg, GetColorU32(properties::accent_color), 0);
		...
		bool Edited::Checkbox(const char* label, const char* description, bool* v) {
			...
			state.background = ImLerp(state.background, *v ? properties::accent_color : properties::elements::background_widget_color, g.IO.DeltaTime * 6.f);
			...
			GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(properties::elements::text_color), description, ImVec2(0.0, 0.8));

			GetWindowDrawList()->AddRectFilled(rect.Min + ImVec2(w - 40, 0), rect.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);
			GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(20, 0), GetColorU32(properties::elements::background_color, 0.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 0.f), properties::elements::rounding);

			const float checkbox_padding = 5.f;

			ImVec2 check_bb_min = rect.Min + ImVec2(w - square_sz - 10.f, (50 - square_sz) / 2);
			ImVec2 check_bb_max = check_bb_min + ImVec2(square_sz, square_sz);

			GetWindowDrawList()->AddRect(check_bb_min, check_bb_max, GetColorU32(state.background), properties::elements::rounding);
			GetWindowDrawList()->AddRectFilled(check_bb_min, check_bb_max, GetColorU32(state.background, 0.5f), properties::elements::rounding);

			PushClipRect(check_bb_min, check_bb_max, true);

			ImVec2 check_center = check_bb_min + ImVec2(square_sz * 0.5f, square_sz * 0.5f);

			float check_mark_size = square_sz * 0.45f;

			RenderCheckMark(GetWindowDrawList(), check_center - ImVec2(check_mark_size * 0.5f, check_mark_size * 0.5f), GetColorU32(state.background, state.alpha), check_mark_size);
		...
		bool ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags) {
			...
			state.background = ImLerp(state.background, (held && hovered) ? properties::tab::tab_active_color : hovered ? properties::elements::background_widget_color : properties::elements::background_color, g.IO.DeltaTime * 7.f);
			/* state.alpha = ImLerp(state.alpha, *v ? 1.f : 0.f, g.IO.DeltaTime * 6.f);
			 state.mark_pos = ImClamp(state.mark_pos + (35.f * g.IO.DeltaTime * (*v ? -3.f : 3.f)), 0.f, 35.f);*/

			 // Render
			const ImU32 col = GetColorU32(state.background);
			RenderNavHighlight(bb, id);
			RenderFrame(bb.Min, bb.Max, col, true, properties::elements::rounding);

			if (g.LogEnabled)
				LogSetNextTextDecoration("[", "]");
			PushStyleColor(ImGuiCol_Text, GetColorU32(properties::elements::text_active_color));
		...
		bool SliderScalar(const char* label, const char* description, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags) {
			...
			GetWindowDrawList()->AddRectFilled(rect.Min + ImVec2(w - 140, 0), rect.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);
			GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(120, 0), GetColorU32(properties::elements::background_color, 0.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 0.f), properties::elements::rounding);

			GetWindowDrawList()->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(properties::elements::background_widget_color), 2.f);
			...
			GetWindowDrawList()->AddRectFilled(frame_bb.Min, ImVec2(state.slow + (frame_bb.Min.x + 9), grab_bb.Max.y), GetColorU32(properties::accent_color), 2.f);

			char value_buf[64];
			const char* value_buf_end = value_buf + DataTypeFormatString(value_buf, IM_ARRAYSIZE(value_buf), data_type, p_data, format);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(properties::elements::text_active_color), label, ImVec2(0.0, 0.2));
			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), rect.Min + ImVec2(0, 7), rect.Max - ImVec2(15, 10), GetColorU32(properties::elements::text_active_color), value_buf, ImVec2(1.0, 0.0f));
		...
		bool BeginCombo(const char* label, const char* description, const char* preview_value, int val, bool multi, ImGuiComboFlags flags) {
			...
			state.text = ImLerp(state.text, state.opened_combo ? properties::elements::text_active_color : hovered ? properties::elements::text_hover_color : properties::elements::text_color, g.IO.DeltaTime * 6.f);
			state.combo_size = ImLerp(state.combo_size, state.opened_combo ? (val * 33) + 17 : 0.f, g.IO.DeltaTime * 12.f);

			GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), bb.Min + ImVec2(10, 0), bb.Max, GetColorU32(properties::elements::text_color), description, ImVec2(0.0, 0.8));

			GetWindowDrawList()->AddRectFilled(bb.Min + ImVec2(w - 140, 0), bb.Max, GetColorU32(properties::elements::background_color), properties::elements::rounding);
			GetWindowDrawList()->AddRectFilledMultiColor(bb.Min, bb.Max - ImVec2(120, 0), GetColorU32(properties::elements::background_color, 0.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 1.f), GetColorU32(properties::elements::background_color, 0.f), properties::elements::rounding);

			GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(properties::elements::background_widget_color), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), rect.Min + ImVec2(10, 0), rect.Max, GetColorU32(properties::elements::text_active_color), preview_value, ImVec2(0.0, 0.5));
			GetWindowDrawList()->AddRectFilled(rect.Max - ImVec2(30, 30), rect.Max, GetColorU32(properties::elements::background_widget_color), 2.f);

			GetWindowDrawList()->AddRectFilledMultiColor(rect.Min, rect.Max - ImVec2(30, 0), GetColorU32(properties::elements::background_widget_color, 0.f), GetColorU32(properties::elements::background_widget_color, 1.f), GetColorU32(properties::elements::background_widget_color, 1.f), GetColorU32(properties::elements::background_widget_color, 0.f), 2.f);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Icomoon-Widget"), 15), rect.Min, rect.Max - ImVec2(7, 0), GetColorU32(properties::accent_color), "z", ImVec2(1.0, 0.5));
			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), bb.Min + ImVec2(10, 0), bb.Max, GetColorU32(properties::elements::text_active_color), label, ImVec2(0.0, 0.2));

			GetWindowDrawList()->AddRectFilled(rect.Max - ImVec2(y_size, y_size), rect.Max, GetColorU32(state.background), properties::elements::rounding);
			...
			PushStyleColor(ImGuiCol_WindowBg, properties::elements::background_color);
			PushStyleColor(ImGuiCol_Border, properties::elements::background_widget_color);
			PushStyleVar(ImGuiStyleVar_WindowRounding, properties::elements::rounding);
		...
		bool Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg) {
			...
			state.text = ImLerp(state.text, selected ? properties::accent_color : properties::elements::text_color, g.IO.DeltaTime * 6.f);
			state.opticaly = ImLerp(state.opticaly, selected ? 1.f : 0.f, g.IO.DeltaTime * 6.f);

			GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max + ImVec2(0, 1), GetColorU32(properties::elements::background_widget_color, state.opticaly), 2.f);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), text_min + ImVec2(1, 1), text_max, GetColorU32(state.text), label, ImVec2(0.f, 0.5f));
		...
		bool RangeSliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v1, float* v2, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags) {
			...
			window->DrawList->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(properties::elements::background_widget_color), 30.f);
			...
			window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x + state.slow1, frame_bb.Min.y), ImVec2(frame_bb.Min.x + state.slow2, frame_bb.Max.y), GetColorU32(properties::accent_color), 2.f);
		...
		bool RangeSliderFloat(const char* label, const char* description, float* v1, float* v2, float v_min, float v_max, const char* display_format, float power) {
			...
			state.text = ImLerp(state.text, IsItemActive() ? properties::elements::text_active_color : hovered ? properties::elements::text_hover_color : properties::elements::text_color, g.IO.DeltaTime * 8.f);
		...
		bool QuandScalar(const char* label, const char* description, ImGuiDataType data_type, void* p_data0, void* p_data1, const void* p_min0, const void* p_max0, const void* p_min1, const void* p_max1, const char* format0, const char* format1, ImGuiSliderFlags flags) {
			...
			GetWindowDrawList()->AddLine(ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Min.y), ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Max.y), GetColorU32(properties::accent_color), 0.5f);
			GetWindowDrawList()->AddShadowRect(ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Min.y), ImVec2(it_anim->second.slow0 + frame_bb.Min.x, grab_bb0.Max.y), GetColorU32(properties::accent_color, 0.5f), 25.f, ImVec2(0, 0), 100.f);

			GetWindowDrawList()->AddLine(ImVec2(grab_bb1.Min.x, it_anim->second.slow1 + frame_bb.Min.y), ImVec2(grab_bb1.Max.x, it_anim->second.slow1 + frame_bb.Min.y), GetColorU32(properties::accent_color), 0.5f);
			GetWindowDrawList()->AddShadowRect(ImVec2(grab_bb1.Min.x, it_anim->second.slow1 + frame_bb.Min.y), ImVec2(grab_bb1.Max.x, it_anim->second.slow1 + frame_bb.Min.y), GetColorU32(properties::accent_color, 0.5f), 25.f, ImVec2(0, 0), 100.f);

			GetWindowDrawList()->AddText(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), 17, ImVec2(rect.Min.x + 10, rect.Min.y + 10), GetColorU32(properties::elements::text_active_color), label);

			std::string blah0(value_buf0), blah1(value_buf1);

			std::string label_x = "[X, " + blah0 + " Y, " + blah1 + "]";

			GetWindowDrawList()->AddText(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), 17, ImVec2(rect.Min.x + 10, rect.Min.y + 30), GetColorU32(properties::elements::text_color), description);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), rect.Min + ImVec2(0, 7), rect.Max - ImVec2(15, 10), GetColorU32(properties::elements::text_active_color), label_x.c_str(), ImVec2(1.0, 0.0f));
		...
		bool icon_box(const char* icon, ImVec2 size, ImU32 color_bg, ImU32 color_icon, ImU32 color_border) {
			...
			GetWindowDrawList()->AddRectFilled(rect.Min, rect.Max, GetColorU32(color_bg), properties::elements::rounding);
			GetWindowDrawList()->AddRect(rect.Min, rect.Max, GetColorU32(color_border), properties::elements::rounding);

			RenderTextColor(g_pFontManager->GetFont(xorstr_("Icomoon-Widget"), 15), rect.Min, rect.Max, GetColorU32(color_icon), icon, ImVec2(0.5, 0.5));
		...
		bool color_button(const char* name, ImVec2 size, ImU32 color_bg) {
			...
			GetWindowDrawList()->AddCircle(rect.Min + ImVec2(size / 2), size.x / 3, GetColorU32(properties::elements::background_color, 0.3f), 30.f, 3.f);
		...
		bool ColorEdit4(const char* label, const char* description, float col[4], ImGuiColorEditFlags flags) {
			flags |= ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_AlphaBar | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_AlphaPreview;
			...
			if (!(flags & ImGuiColorEditFlags_NoSmallPreview)) {
				...
				PushStyleColor(ImGuiCol_WindowBg, GetColorU32(properties::elements::background_color));
				PushStyleColor(ImGuiCol_Border, GetColorU32(properties::elements::background_widget_color));
				...
				if (state.active) {
					...
					Begin("picker", NULL, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_AlwaysAutoResize);
					{
						...
						GetWindowDrawList()->AddText(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), 17.f, GetCursorScreenPos() - ImVec2(0, 2), GetColorU32(properties::elements::text_active_color), (label != label_display_end && !(flags & ImGuiColorEditFlags_NoLabel)) ? label : "Color picker");

						PushFont(g_pFontManager->GetFont(xorstr_("Icomoon-Widget"), 16));
						ImGui::GetWindowDrawList()->AddText(GetCursorScreenPos() + ImVec2(GetContentRegionMax().x - (CalcTextSize("l").x + 15), 0), GetColorU32(properties::elements::text_hover_color), "l");
						PopFont();
						...
						if (Edited::icon_box("u", ImVec2(35, 35), GetColorU32(properties::elements::background_widget_color), GetColorU32(properties::accent_color), GetColorU32(properties::accent_color, state.alpha_search))) {
							search_col = true;
						};
						...
						if (Edited::icon_box(add_status ? "g" : "k", ImVec2(35, 35), GetColorU32(properties::elements::background_widget_color), GetColorU32(properties::accent_color), GetColorU32(properties::accent_color, 0.f))) {
			...
			state.text = ImLerp(state.text, state.active ? properties::elements::text_active_color : properties::elements::text_color, g.IO.DeltaTime * 6.f);

			if (label != label_display_end && !(flags & ImGuiColorEditFlags_NoLabel)) {
				SameLine(0.0f, style.ItemInnerSpacing.x);
				window->DC.CursorPos.x = pos.x - w_button + ((flags & ImGuiColorEditFlags_NoInputs) ? w_button : w_full);

				RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14), pos + ImVec2(10, 0), pos + ImVec2(GetContentRegionMax().x, 50), GetColorU32(properties::elements::text_color), description, ImVec2(0.0, 0.8));
				RenderTextColor(g_pFontManager->GetFont(xorstr_("Lexend-Bold"), 17), pos + ImVec2(10, 0), pos + ImVec2(GetContentRegionMax().x, 50), GetColorU32(properties::elements::text_active_color), label, ImVec2(0.0, 0.2));
		...
		bool ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, const ImVec2& size_arg) {
			...
			GetWindowDrawList()->AddRectFilled(clickable.Min, clickable.Max, GetColorU32(col_rgb), properties::elements::rounding);

			RenderColorRectWithAlphaCheckerboard(window->DrawList, clickable.Min, clickable.Max, GetColorU32(col_rgb), ImMin(20, 20) / 2.99f, ImVec2(0.f, 0.f), properties::elements::rounding);
		...
		void EspPreview(ImTextureID player_preview, bool* nickname, float nick_color[4], bool* weapon, float weapon_color[4], int* hp, float hp_color[4], bool* zoom, float zoom_color[4], bool* bomb, float bomb_color[4], bool* c4, float c4_color[4], bool* money, float money_color[4], bool* hit, float hit_color[4], bool* esp_box, float box_color[4], bool* hp_line, float hp_line_color[4]) {
			...
			GetWindowDrawList()->AddImage(player_preview, player.Min, player.Max, ImVec2(0, 0), ImVec2(1, 1), GetColorU32(properties::elements::text_active_color));

			static std::vector<std::string> partyNames = { "Nickname", "95%", "Zoomed", "Weapon", "Bomb", "50$", "HIT", "C4" };

			PushFont(g_pFontManager->GetFont(xorstr_("Lexend-Regular"), 14));
			PushStyleColor(ImGuiCol_Text, GetColorU32(properties::elements::text_active_color));
			...
			if (*hp_line)  GetWindowDrawList()->AddLine(box.Min + ImVec2(-10, 0), box.Min + ImVec2(-10, 307), GetColorU32(properties::elements::background_widget_color), 3.f);
			if (*hp_line)  GetWindowDrawList()->AddLine(box.Min + ImVec2(-10, 307 - hp_result), box.Min + ImVec2(-10, 307), GetColorU32(properties::accent_color), 3.f);
